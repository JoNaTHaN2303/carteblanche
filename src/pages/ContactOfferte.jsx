...
export default function Contact(){
  const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_plksqjj', 'template_9p024fj', e.target, 'KtSu-9wfoG4RPYEE2')
          .then((result) => {
  ...
  return (
    <div id='contact' className='h-min flex flex-col items-center justify-center px-10 md:px-20 lg:px-40 py-10'>
        <div className='flex flex-col justify-center items-center w-full md:w-3/4 lg:w-1/2 mb-14'>
            <GoFile className='w-24 h-24 text-[#ab0f2a] mb-4'/>
            <p className='text-gray-600 text-center font-normal text-3xl mb-16'>Vraag een offerte</p>
            <p className='text-gray-400 text-center text-lg font-normal mb-1'>Een offerte nodig van onze full service catering, personeelsfeest of huwelijk?</p>
            ...
            <div className='w-full md:w-3/4 xl:w-1/2 px-7 py-4 bg-gray-200 rounded'>
              <form action='' onSubmit={sendEmail} className='flex flex-col w-full'>
                ...
                <input
                    ...
                    className='field mt-2 mb-3 p-1 rounded-md'
                ></input>
                <label className='mt-4'>Locatie:</label>
                <input
                    type='text'
                    name='locatie'
                    placeholder='Locatie'
                    className='field mt-2 mb-3 p-1 rounded-md text-gray-400'
                ></input>
                <label className='mt-4'>Datum van het feest:</label>
                <input
                    type='date'
                    name='datum'
                    ...
                    className='field mt-2 mb-3 p-1 rounded-md'
                ></input>
                <label className='mt-4'>Verwacht aantal gasten:</label>
                <input 
                    type='number'
                    name='aantalgasten'
                    placeholder='Aantal gasten'
                    className='field mt-2 mb-3 p-1 rounded-md appearance-none'
                ></input>
                <label className='mt-4'>Concept:</label>
                <textarea 
